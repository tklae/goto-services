...
ssh -i /root/.ssh/id_rsa -o "StrictHostKeyChecking no" vagrant@12.12.12.12 "/environment/$STAGE/$SERVICE_NAME/scripts/stop_$STAGE.sh"
ssh -i /root/.ssh/id_rsa -o "StrictHostKeyChecking no" vagrant@12.12.12.12 "/environment/$STAGE/$SERVICE_NAME/scripts/start_$STAGE.sh"